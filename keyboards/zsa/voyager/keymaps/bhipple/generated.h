...
KC_NO, KC_SPACE, KC_NO, KC_NO
 ...
 KC_ESCAPE            , KC_1                 , KC_F2                , KC_F3                , KC_F4                , KC_F5, KC_F6                , KC_F7                , KC_F8                , KC_F9                , KC_F10               , KC_F11                
    , 
 KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_LT                , KC_GT                , KC_TRANSPARENT, KC_TRANSPARENT       , KC_7                 , KC_8                 , KC_9                 , KC_ASTERISK          , KC_F12                
    , 
 KC_MINUS             , KC_PLUS              , KC_EQUAL             , KC_LBRC              , KC_RBRC              , KC_TRANSPARENT, KC_TRANSPARENT       , KC_4                 , KC_5                 , KC_6                 , KC_PLUS              , KC_TRANSPARENT        
    , 
 KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_LEFT_CURLY_BRACE  , KC_RIGHT_CURLY_BRACE , KC_TRANSPARENT, KC_0                 , KC_1                 , KC_2                 , KC_3                 , KC_TRANSPARENT       , KC_TRANSPARENT        
    , 
KC_NO, KC_SPACE, KC_NO, KC_NO
 ...
 KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT, KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT        
    , 
 KC_TRANSPARENT       , TO(Qwerty)           , TO(Colemak)          , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT, KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT        
    , 
 KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , M_PASTE              , KC_ESCAPE            , KC_TRANSPARENT, KC_LEFT              , KC_DOWN              , KC_UP                , KC_RIGHT             , KC_TRANSPARENT       , M_EOL_SEMICOLON       
    , 
 KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT, D_BLUETOOTH_CON      , KC_KB_MUTE           , KC_KB_VOLUME_DOWN    , KC_KB_VOLUME_UP      , D_BLUETOOTH_DISC     , QK_BOOTLOADER         
    , 
KC_NO, KC_SPACE, KC_NO, KC_NO

  ),

  [LeftIdx] = LAYOUT_voyager(
...
KC_NO, KC_SPACE, KC_NO, KC_NO
  ...
  [RightIdx] = LAYOUT_voyager(
      
 KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT, KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT        
    , 
 KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , D_PROGRAM            , KC_TRANSPARENT, KC_TRANSPARENT       , D_TERMINAL           , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT        
    , 
 KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_ENTER             , KC_BACKSPACE         , KC_TRANSPARENT, KC_TRANSPARENT       , KC_TRANSPARENT       , KC_ENTER             , KC_ESCAPE            , KC_TRANSPARENT       , KC_TRANSPARENT        
    , 
...
KC_NO, KC_SPACE, KC_NO, KC_NO
  ...
  [Editor] = LAYOUT_voyager(
      
 KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT, KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT        
    , 
 KC_TRANSPARENT       , M_COLON_Q            , M_COLON_W            , KC_TRANSPARENT       , M_SPC_P_P            , M_COLON_DIFFPUT, M_BRKT_R_C           , KC_F1                , KC_F2                , KC_F3                , KC_F4                , KC_TRANSPARENT        
    , 
 KC_TRANSPARENT       , M_COLON_DIFFGET      , M_SPC_R_T            , KC_TRANSPARENT       , KC_TRANSPARENT       , M_SPC_STAR, M_BRKT_L_C           , M_gT                 , M_gt                 , M_EMACS_RIGHT        , KC_TRANSPARENT       , KC_TRANSPARENT        
    , 
 KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , M_COLON_TABNEW       , M_COLON_B_D          , M_COLON_V_S_P, KC_TRANSPARENT       , M_SPC_P_F            , KC_TRANSPARENT       , KC_TRANSPARENT       , M_SPC_SLASH          , KC_TRANSPARENT        
    , 
KC_NO, KC_SPACE, KC_NO, KC_NO
 ...
 KC_TRANSPARENT       , M_TMUX_WINDOW_1      , M_TMUX_WINDOW_2      , M_TMUX_WINDOW_3      , M_TMUX_WINDOW_4      , M_TMUX_WINDOW_5, M_TMUX_WINDOW_6      , M_TMUX_WINDOW_7      , M_TMUX_WINDOW_8      , M_TMUX_WINDOW_9      , KC_TRANSPARENT       , KC_TRANSPARENT        
    , 
 KC_TRANSPARENT       , KC_TRANSPARENT       , M_TMUX_LIST_WINDOWS  , M_TMUX_FILE          , KC_TRANSPARENT       , KC_TRANSPARENT, KC_TRANSPARENT       , M_TMUX_WINDOW_LEFT   , M_TMUX_WINDOW_RIGHT  , KC_TRANSPARENT       , M_TMUX_SWAP_PANES    , KC_TRANSPARENT        
    , 
 KC_TRANSPARENT       , KC_TRANSPARENT       , M_TMUX_RERUN         , M_TMUX_SPLIT         , M_TMUX_SCROLL        , M_CLEAR, M_TMUX_LEFT          , M_TMUX_PREV          , M_TMUX_NEXT          , M_TMUX_RIGHT         , KC_TRANSPARENT       , KC_TRANSPARENT        
    , 
 KC_TRANSPARENT       , M_TMUX_ZOOM          , KC_TRANSPARENT       , M_TMUX_CREATE        , M_TMUX_DELETE        , M_TMUX_VSPLIT, KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , KC_TRANSPARENT       , M_TMUX_SEARCH        , KC_TRANSPARENT        
    , 
KC_NO, KC_SPACE, KC_NO, KC_NO
