...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [Colemak] = LAYOUT_ansi_69(
        ...
        KC_CAPS, KC_A,     KC_R,     KC_S,    KC_T,    KC_G,              KC_K,    KC_N,    KC_E,    KC_I,     KC_O,     KC_SCLN,  KC_ENT,           KC_HOME,
    ...
    [WIN_BASE] = LAYOUT_ansi_69(
        ...
        KC_CAPS, KC_A,     KC_S,     KC_D,    KC_F,    KC_G,              KC_H,    KC_J,    KC_K,    KC_L,     KC_SCLN,  QK_MOUSE_BUTTON_1,  KC_ENT,           KC_TAB,
