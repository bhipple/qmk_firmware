...
To flash, run this from the git root of this project:
  ...
  #+BEGIN_SRC sh
./keyboards/bastardkb/scylla/keymaps/bhipple/regen.py && nix-shell --run './bin/qmk flash'
  #+END_SRC
...
| LT(Macros, KC_LSFT)  | LT(NumPad, KC_Z)     | LT(Tmux, KC_X)       | LT(Emacs, KC_C)      | KC_D                 | KC_V                 |   | KC_M                 | KC_H                 | LT(Emacs, KC_COMM)   | LT(Tmux, KC_DOT)     | LT(NumPad, KC_SLSH)  | LT(Macros, KC_RSHIFT) |
