...
| KC_LSFT              | LT(NumPad, KC_Z)     | LT(Tmux, KC_X)       | LT(Emacs, KC_C)      | KC_D                 | KC_V                 |   | KC_M                 | KC_H                 | LT(Emacs, KC_COMM)   | LT(Tmux, KC_DOT)     | LT(NumPad, KC_SLSH)  | LT(Macros, KC_RSHIFT) |
...
| KC_TRANSPARENT       | KC_TRANSPARENT       | M_SPC_R_T            | M_COLON_S_P          | M_SPC_G_S            | M_SPC_STAR           |   | M_EMACS_LEFT         | M_EMACS_DOWN         | M_EMACS_UP           | M_EMACS_RIGHT        | KC_TRANSPARENT       | KC_TRANSPARENT        |
...
| KC_TRANSPARENT       | KC_TRANSPARENT       | M_TMUX_RERUN         | M_TMUX_SPLIT         | M_TMUX_SCROLL        | M_CLEAR              |   | M_TMUX_UP            | M_TMUX_NEXT          | M_TMUX_WINDOW_LEFT   | M_TMUX_WINDOW_RIGHT  | KC_TRANSPARENT       | KC_TRANSPARENT        |
