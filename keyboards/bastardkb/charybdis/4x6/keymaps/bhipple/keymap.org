...
#+BEGIN_SRC sh
./keyboards/bastardkb/charybdis/4x6/keymaps/bhipple/regen.py && nix-shell --run 'qmk flash -km bhipple -kb bastardkb/charybdis/4x6'
  #+END_SRC
...
|                      |                      |                      | KC_SPACE             | KC_SPACE             | KC_NO                |   | KC_TAB               | KC_NO                |                      |                      |                      |                       |
|                      |                      |                      |                      | KC_NO                | KC_NO                |   | KC_NO                |                      |                      |                      |                      |                       |
...
| KC_TRANSPARENT       | KC_TRANSPARENT       | KC_TRANSPARENT       | KC_TRANSPARENT       | KC_TRANSPARENT       | KC_TRANSPARENT       |   | D_BLUETOOTH_CON      | KC__MUTE             | KC__VOLDOWN          | KC__VOLUP            | KC_TRANSPARENT       | RESET                 |
|                      |                      |                      | KC_TRANSPARENT       | KC_TRANSPARENT       | KC_TRANSPARENT       |   | KC_TRANSPARENT       | KC_TRANSPARENT       |                      |                      |                      |                       |
|                      |                      |                      |                      | KC_TRANSPARENT       | KC_TRANSPARENT       |   | KC_TRANSPARENT       |                      |                      |                      |                      |                       |
...
| KC_TRANSPARENT       | KC_TRANSPARENT       | M_SPC_R_T            | M_EMACS_TAB_PREV     | M_EMACS_TAB_NEXT     | M_SPC_STAR           |   | M_EMACS_LEFT         | M_EMACS_DOWN         | M_EMACS_UP           | M_EMACS_RIGHT        | KC_TRANSPARENT       | KC_TRANSPARENT        |
| KC_TRANSPARENT       | KC_TRANSPARENT       | KC_TRANSPARENT       | KC_TRANSPARENT       | M_COLON_B_D          | M_COLON_V_S_P        |   | KC_TRANSPARENT       | M_SPC_P_F            | KC_TRANSPARENT       | KC_TRANSPARENT       | M_SPC_SLASH          | KC_TRANSPARENT        |
|                      |                      |                      | KC_TRANSPARENT       | KC_TRANSPARENT       | KC_TRANSPARENT       |   | KC_TRANSPARENT       | KC_TRANSPARENT       |                      |                      |                      |                       |
|                      |                      |                      |                      | KC_TRANSPARENT       | KC_TRANSPARENT       |   | KC_TRANSPARENT       |                      |                      |                      |                      |                       |
...
| KC_TRANSPARENT       | KC_TRANSPARENT       | M_TMUX_LIST_WINDOWS  | M_TMUX_FILE          | KC_TRANSPARENT       | KC_TRANSPARENT       |   | KC_TRANSPARENT       | KC_TRANSPARENT       | M_TMUX_URL           | KC_TRANSPARENT       | M_TMUX_SWAP_PANES    | KC_TRANSPARENT        |
| KC_TRANSPARENT       | KC_TRANSPARENT       | M_TMUX_RERUN         | M_TMUX_PREV          | M_TMUX_NEXT          | M_CLEAR              |   | M_TMUX_LEFT          | M_TMUX_DOWN          | M_TMUX_UP            | M_TMUX_RIGHT         | KC_TRANSPARENT       | KC_TRANSPARENT        |
