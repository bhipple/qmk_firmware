...
if hwinfo | grep -i Scylla; then nix-shell --run 'qmk flash -km bhipple -kb bastardkb/scylla/v1/elitec'; fi
if hwinfo | grep -i Charybdis; then nix-shell --run 'qmk flash -km bhipple -kb bastardkb/charybdis/4x6/v1/elitec'; fi
